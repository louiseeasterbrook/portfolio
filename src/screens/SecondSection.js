      ...
      <div className="second-container">
        ...
        <div className="card-holder">
          <WebsiteCard
            ...
            webDescription="Full-stack poem posting website that gives all basic CRUD functionality. Each Poem can be 'up voted' and will display a count of their votes."
